...
export class SetupSQL extends SQL {
    sqls = [
        ...
        `CREATE TABLE IF NOT EXISTS "public"."book" ("id" SERIAL NOT NULL, "title" character varying(255) NOT NULL, "author" character varying(100) NOT NULL, "publisher" character varying(100) NOT NULL, "condition" character varying(15) check ("condition" in ('new', 'used')) NOT NULL NOT NULL, "image" text NOT NULL, "date" date NOT NULL, "type" character varying(15) check ("type" in ('donate', 'trade')) NOT NULL, "state" character varying(100) NOT NULL, "city" character varying(100) NOT NULL, "cpf" character varying(11) NOT NULL, CONSTRAINT "pk_book_id" PRIMARY KEY ("id"))`,
